...
def build_photo_attach(
    ...
    """Tạo D3 Attachment JSON Dictionary cho Hình ảnh (tType = 3)."""
    return {
        "title": title,
...
def build_photo_binary_payload(
    ...
    # 1. Header block [2B LE sub_type][1B feature_blocks_count = 0]
...
def build_photo_message_packet(
    ...
    """Tạo Inner Packet gửi tin nhắn hình ảnh Native (CMD 207/113 SUB 32/37)."""
    from core.socket.protocol import (
