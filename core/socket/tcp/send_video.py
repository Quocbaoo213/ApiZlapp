...
def build_video_attach(
    ...
    """Tạo D3 Attachment JSON Dictionary cho Video (tType = 4)."""
    return {
        "title": title,
...
def build_video_message_packet(
    ...
    """
    Tạo Inner Packet gửi tin nhắn Video Native (CMD 207/113 SUB 44) hoặc D3 attachment fallback (SUB 1/41).
    """
    from core.socket.protocol import (
