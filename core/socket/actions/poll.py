...
class PollActionMixin:
    """Mixin xử lý tạo bình chọn qua Socket."""
    ...
    def create_poll(
        ...
        allow_add_option: bool = True,
        is_anonymous: bool = False,
        hide_vote_result: bool = False,
        allow_share: bool = True
    ) -> bool:
        """Tạo cuộc bình chọn (Poll) trong nhóm chat Zalo (CMD 1640 SUB 3)."""
        ...
        try:
            ...
            inner = build_create_poll_packet(
                ...
                hide_vote_result=hide_vote_result,
