...
class SendDoodleAPI(BaseAPI):
    ...
    def send_group_doodle(self, group_id: Union[int, str], doodle_url_or_path: str, caption: str='', **kwargs) -> bool:
        return self.send_doodle(target_id=group_id, doodle_url_or_path=doodle_url_or_path, thread_type=ThreadType.GROUP, caption=caption, **kwargs)

    def send_1to1_doodle(self, to_uid: Union[int, str], doodle_url_or_path: str, caption: str='', **kwargs) -> bool:
        return self.send_doodle(target_id=to_uid, doodle_url_or_path=doodle_url_or_path, thread_type=ThreadType.USER, caption=caption, **kwargs)
