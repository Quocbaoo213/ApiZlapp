...
class SendImageAPI(BaseAPI):
    ...
    def send_group_photo(self, group_id: Union[int, str], photo_url_or_path: str, caption: str='', **kwargs) -> bool:
        return self.send_photo(target_id=group_id, photo_url_or_path=photo_url_or_path, thread_type=ThreadType.GROUP, caption=caption, **kwargs)

    def send_1to1_photo(self, to_uid: Union[int, str], photo_url_or_path: str, caption: str='', **kwargs) -> bool:
        return self.send_photo(target_id=to_uid, photo_url_or_path=photo_url_or_path, thread_type=ThreadType.USER, caption=caption, **kwargs)
